export default {
  ...
  greeting: 'Hello',
  intro: 'Qui suis-je ? Que fais-je ?',
  description: 'Je suis un développeur C#, .Net Core et VueJS enthousiaste, titulaire d’un Master E-Services et ayant deux ans d’expérience dans la supply chain. Je suis animé par la pyrotechnie et le scoutisme, et je cultive la créativité et la rigueur dans mon travail et mes engagements.',
  ...
  experiences: [
    ...
    },
    {
      ...
      descriptionTitle: 'Missions',
      descriptions: [
        'Développement d’une application web basée sur React',
        'Refonte du design et de l’interface utilisateur d’un CRM de gestion d’inventaire',
